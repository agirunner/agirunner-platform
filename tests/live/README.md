...
- prose-only optional-control contract scenarios proving that unconfigured approval, assessment, escalation, and successor suggestions remain advisory and non-blocking
