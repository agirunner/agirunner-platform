...
LIVE_TEST_WORKFLOW_GOAL="${LIVE_TEST_WORKFLOW_GOAL:-Add support for named greetings and uppercase output while preserving the default greeting, with updated docs and regression tests.}"
LIVE_TEST_APPROVAL_MODE="${LIVE_TEST_APPROVAL_MODE:-none}"
...
export LIVE_TEST_WORKFLOW_GOAL
export LIVE_TEST_APPROVAL_MODE
export LIVE_TEST_BOOTSTRAP_CONTEXT_FILE
