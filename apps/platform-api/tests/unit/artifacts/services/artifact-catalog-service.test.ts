...
import { ArtifactCatalogService } from '../../../../src/services/artifacts/artifact-catalog-service.js';
...
describe('ArtifactCatalogService', () => {
  ...
  it('redacts secret-like catalog metadata values even when the field name is not secret-like', async () => {
    const pool = {
      query: vi
        .fn()
        .mockResolvedValueOnce({
