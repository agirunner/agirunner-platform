        ...
        if (sql.includes('FROM workflow_work_items') && sql.includes('AND id = $2')) {
          ...
          return {
            rows: [{
              ...
              unresolved_findings: [],
              review_focus: ['Preserve the approved design contract'],
        ...
        if (
          ...
          return {
            rows: [{
              ...
              remaining_items: [],
              blockers: [],
              review_focus: ['Validate implementation against the design'],
              known_risks: ['Implementation drift'],
        ...
        if (sql.includes('FROM workflow_work_items') && sql.includes('AND id = $2')) {
          ...
          return {
            rows: [{
              ...
              unresolved_findings: [],
              review_focus: ['Validate final PRD language'],
              known_risks: ['Attribution drift'],
              priority: 'high',
              notes: null,
            }],
