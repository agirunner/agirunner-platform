      ...
      query: vi.fn(async (sql: string, params?: unknown[]) => {
        ...
        if (sql.startsWith('UPDATE tasks SET')) {
          return {
            rowCount: 1,
            rows: [{
              id: 'task-review-cancelling-reopen',
              state: 'ready',
              workflow_id: 'workflow-1',
              work_item_id: 'work-item-1',
              stage_name: 'implementation',
              ...
              title: 'Implement change',
              is_orchestrator_task: false,
              input: { assessment_feedback: 'Keep the work parked in its current lane while cancellation settles.' },
              metadata: { assessment_action: 'request_changes' },
              rework_count: 1,
              completed_at: null,
            }],
        ...
        if (
          ...
          return {
            ...
            rows: [{
              ...
              completed_at: new Date('2026-03-21T02:05:00Z'),
              workflow_state: 'active',
              workflow_metadata: { cancel_requested_at: '2026-03-21T02:06:00Z' },
              definition: {
                roles: ['developer', 'reviewer'],
                lifecycle: 'planned',
                board: {
        ...
        if (sql.startsWith('INSERT INTO workflow_activations')) {
          return {
            ...
            rows: [{
              ...
              workflow_id: 'workflow-1',
              activation_id: null,
              request_id: 'task-assessment-requested:task-review-cancelling-reopen:Sat Mar 21 2026 02:10:00 GMT+0000 (Coordinated Universal Time)',
              reason: 'task.assessment_requested_changes',
              event_type: 'task.assessment_requested_changes',
              payload: { task_id: 'task-review-cancelling-reopen' },
              state: 'queued',
              dispatch_attempt: 0,
              dispatch_token: null,
              queued_at: new Date('2026-03-21T02:10:00Z'),
        ...
        if (sql.includes('COUNT(*)::int AS engaged_task_count')) {
          return { rows: [{ engaged_task_count: 0 }], rowCount: 1 };
        }
        return { rows: [], rowCount: 0 };
      }),
      release: vi.fn(),
      ...
      query: vi.fn(async (sql: string, params?: unknown[]) => {
        ...
        if (sql.startsWith('UPDATE tasks SET')) {
          return {
            rowCount: 1,
            rows: [{
              id: 'task-review-cancelled-reopen',
              state: 'ready',
              workflow_id: 'workflow-1',
              work_item_id: 'work-item-1',
              stage_name: 'implementation',
              ...
              title: 'Implement change',
              is_orchestrator_task: false,
              input: { assessment_feedback: 'Capture the rejected work without reopening active execution.' },
              metadata: { assessment_action: 'request_changes' },
              rework_count: 1,
              completed_at: null,
            }],
        ...
        if (sql.startsWith('INSERT INTO workflow_activations')) {
          return {
            ...
            rows: [{
              ...
              workflow_id: 'workflow-1',
              activation_id: null,
              request_id: 'task-assessment-requested:task-review-cancelled-reopen:Sat Mar 21 2026 02:10:00 GMT+0000 (Coordinated Universal Time)',
              reason: 'task.assessment_requested_changes',
              event_type: 'task.assessment_requested_changes',
              payload: { task_id: 'task-review-cancelled-reopen' },
              state: 'queued',
              dispatch_attempt: 0,
              dispatch_token: null,
              queued_at: new Date('2026-03-21T02:10:00Z'),
