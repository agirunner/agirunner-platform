...
vi.mock('../../../src/services/platform-config/platform-timing-defaults.js', async () => {
  const actual = await vi.importActual<typeof import('../../../src/services/platform-config/platform-timing-defaults.js')>(
    '../../../src/services/platform-config/platform-timing-defaults.js',
  );
  return {
    ...actual,
...
import { readLifecycleMonitorTimingDefaults } from '../../../src/services/platform-config/platform-timing-defaults.js';
