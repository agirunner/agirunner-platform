...
describe('gate decision route idempotency', () => {
  ...
  afterEach(async () => {
    ...
    vi.doUnmock('../../../../../src/services/workflow-control/workflow-state-service.js');
    vi.doUnmock('../../../../../src/services/workflow-activation/workflow-activation-service.js');
    vi.doUnmock('../../../../../src/services/workflow-activation-dispatch/workflow-activation-dispatch-service.js');
    if (app) {
      await app.close();
      app = undefined;
    }
  ...
  it('deduplicates repeated approval queue gate decisions by request_id', async () => {
    ...
    vi.doMock('../../../../../src/services/playbook-workflow-control/playbook-workflow-control-service.js', () => ({
      PlaybookWorkflowControlService: vi.fn().mockImplementation(() => ({
        actOnGate,
      })),
    }));
    vi.doMock('../../../../../src/services/workflow-control/workflow-state-service.js', () => ({
    ...
    vi.doMock('../../../../../src/services/workflow-activation-dispatch/workflow-activation-dispatch-service.js', () => ({
