...
function buildActivationRoleConfig(): Record<string, unknown> {
  return {
    system_prompt: [
      ...
      'If you routed work, requested a gate, closed or reopened work, or chose to wait after inspection, submit_handoff in that same activation before attempting completion.',
