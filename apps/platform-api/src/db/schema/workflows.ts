...
export const workflows = pgTable(
  'workflows',
  {
    ...
    redriveReason: text('redrive_reason'),
    redriveInputPacketId: uuid('redrive_input_packet_id'),
    inheritedInputPacketIdsJson: jsonb('inherited_input_packet_ids_json').notNull().default([]),
  ...
  (table) => [
    ...
    index('idx_workflows_attempt_group').on(table.tenantId, table.attemptGroupId, table.attemptNumber),
