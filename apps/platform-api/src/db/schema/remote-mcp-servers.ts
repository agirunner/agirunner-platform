...
export const remoteMcpServers = pgTable(
  'remote_mcp_servers',
  {
    ...
    verifiedDiscoveryStrategy: text('verified_discovery_strategy'),
    verifiedOAuthStrategy: text('verified_oauth_strategy'),
    ...
    discoveredResourcesSnapshot: jsonb('discovered_resources_snapshot').notNull().default([]),
    discoveredPromptsSnapshot: jsonb('discovered_prompts_snapshot').notNull().default([]),
    verifiedCapabilitySummary: jsonb('verified_capability_summary').notNull().default({}),
