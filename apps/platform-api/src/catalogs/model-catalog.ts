...
const OPENAI_NATIVE_SEARCH: NativeSearchCapability = {
  mode: 'openai_web_search',
  defaultEnabled: true,
};
const ANTHROPIC_NATIVE_SEARCH: NativeSearchCapability = {
  mode: 'anthropic_web_search_20250305',
  defaultEnabled: true,
};
const GOOGLE_NATIVE_SEARCH: NativeSearchCapability = {
  mode: 'google_search',
  defaultEnabled: true,
};
...
function m(
  ...
  reasoningConfig: ReasoningConfig | null,
  nativeSearch: NativeSearchCapability | null = null,
): ModelCatalogEntry {
  return {
...
export const MODEL_CATALOG: Record<string, ModelCatalogEntry> = {
  /* OpenAI: GPT-5.4 */
  'gpt-5.4-pro':        m(1050000, 128000, 'responses', true, true, 30,    180,   OAI_GPT54_PRO_REASONING, OPENAI_NATIVE_SEARCH),
  'gpt-5.4':            m(1050000, 128000, 'responses', true, true, 2.5,   15,    OAI_GPT54_REASONING, OPENAI_NATIVE_SEARCH),
  'gpt-5.4-mini':       m(400000,  128000, 'responses', true, true, 0.75,  4.5,   OAI_GPT54_REASONING, OPENAI_NATIVE_SEARCH),
  'gpt-5.4-nano':       m(400000,  128000, 'responses', true, true, 0.20,  1.60,  OAI_GPT54_REASONING, OPENAI_NATIVE_SEARCH),
  /* OpenAI: GPT-5.3 */
  'gpt-5.3-codex':      m(400000,  128000, 'responses', true, true, 1.75,  14,    OAI_XHIGH, OPENAI_NATIVE_SEARCH),
  'gpt-5.3-codex-spark':m(272000,  128000, 'responses', true, false, null, null,  null, OPENAI_NATIVE_SEARCH),
  /* OpenAI: GPT-5.2 */
  'gpt-5.2':            m(1050000, 128000, 'responses', true, true, 1.75,  14,    OAI_GPT52_REASONING, OPENAI_NATIVE_SEARCH),
  'gpt-5.2-pro':        m(1050000, 128000, 'responses', true, true, 10.5,  84,    OAI_XHIGH, OPENAI_NATIVE_SEARCH),
  'gpt-5.2-codex':      m(1050000, 128000, 'responses', true, true, 1.75,  14,    OAI_XHIGH, OPENAI_NATIVE_SEARCH),
  /* OpenAI: GPT-5.1 */
  'gpt-5.1-codex-max':  m(1050000, 128000, 'responses', true, true, 1.25,  10,    OAI_XHIGH, OPENAI_NATIVE_SEARCH),
  'gpt-5.1-codex':      m(1050000, 128000, 'responses', true, true, 1.25,  10,    OAI_O_SERIES, OPENAI_NATIVE_SEARCH),
  'gpt-5.1':            m(1050000, 128000, 'responses', true, true, 1.25,  10,    OAI_GPT51_REASONING, OPENAI_NATIVE_SEARCH),
  /* OpenAI: GPT-5 */
  'gpt-5-pro':          m(1050000, 128000, 'responses', true, true, 15,    120,   OAI_GPT5_PRO_REASONING, OPENAI_NATIVE_SEARCH),
  'gpt-5':              m(1050000, 128000, 'responses', true, true, 1.25,  10,    OAI_GPT5_REASONING, OPENAI_NATIVE_SEARCH),
  'gpt-5-codex':        m(1050000, 128000, 'responses', true, true, 1.25,  10,    OAI_O_SERIES, OPENAI_NATIVE_SEARCH),
  'gpt-5-mini':         m(400000,  128000, 'responses', true, true, 0.25,  2,     OAI_GPT5_REASONING, OPENAI_NATIVE_SEARCH),
  'gpt-5-nano':         m(1050000, 128000, 'responses', true, true, 0.05,  0.4,   OAI_GPT5_REASONING, OPENAI_NATIVE_SEARCH),
  'gpt-5-codex-mini':   m(262144,  128000, 'responses', true, false, null, null,  OAI_XHIGH, OPENAI_NATIVE_SEARCH),
  /* OpenAI: GPT-4.1 */
  ...
  /* OpenAI: o-series */
  'o4-mini':            m(200000,  100000, 'responses', true, true, 1.1,   4.4,   OAI_O_SERIES, OPENAI_NATIVE_SEARCH),
  'o3':                 m(200000,  100000, 'responses', true, true, 2,     8,     OAI_O_SERIES, OPENAI_NATIVE_SEARCH),
  'o3-pro':             m(200000,  100000, 'responses', true, true, 20,    80,    OAI_O_SERIES, OPENAI_NATIVE_SEARCH),
  'o3-mini':            m(200000,  100000, 'responses', true, true, 1.1,   4.4,   OAI_O_SERIES, OPENAI_NATIVE_SEARCH),
  'o1':                 m(200000,  100000, 'responses', true, true, 15,    60,    OAI_O_SERIES, OPENAI_NATIVE_SEARCH),
  'o1-pro':             m(200000,  100000, 'responses', true, true, 150,   600,   OAI_O_SERIES, OPENAI_NATIVE_SEARCH),
  ...
  /* Google: Gemini 3.x */
  'gemini-3.1-pro-preview':       m(1048576, 65536, 'generate-content', true, true, 2,    12,   GEM_31_PRO, GOOGLE_NATIVE_SEARCH),
  'gemini-3-pro-preview':         m(1048576, 65536, 'generate-content', true, true, 2,    12,   GEM_3_PRO, GOOGLE_NATIVE_SEARCH),
  'gemini-3-flash-preview':       m(1048576, 65536, 'generate-content', true, true, 0.5,  3,    GEM_3_FLASH, GOOGLE_NATIVE_SEARCH),
  'gemini-3.1-flash-lite-preview':m(1048576, 65536, 'generate-content', true, true, 0.25, 1.5,  GEM_31_FLASH_LITE, GOOGLE_NATIVE_SEARCH),
  /* Google: Gemini 2.x legacy */
  'gemini-2.5-pro':    m(1048576, 65536,  'generate-content', true, true, 1.25,  10,    GEM_25_PRO, GOOGLE_NATIVE_SEARCH),
  'gemini-2.5-flash':  m(1048576, 65536,  'generate-content', true, true, 0.3,   2.5,   GEM_25_FLASH, GOOGLE_NATIVE_SEARCH),
  'gemini-2.0-flash':  m(1048576, 8192,   'generate-content', true, true, 0.1,   0.4,   null, GOOGLE_NATIVE_SEARCH),
};
 ...
 */
export function findCatalogEntry(modelId: string | null | undefined): ModelCatalogEntry | undefined {
  ...
  if (MODEL_CATALOG[normalizedModelId]) return MODEL_CATALOG[normalizedModelId];

  let bestMatch: ModelCatalogEntry | undefined;
  let bestLen = 0;
  for (const [key, entry] of Object.entries(MODEL_CATALOG)) {
    if (normalizedModelId.startsWith(key) && key.length > bestLen) {
      bestMatch = entry;
      bestLen = key.length;
    }
  }
...
export function readNativeSearchCapability(modelId: string | null | undefined): NativeSearchCapability | null {
  const capability = findCatalogEntry(modelId)?.nativeSearch;
  if (!capability) {
    return null;
  }
  return { ...capability };
