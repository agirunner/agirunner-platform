...
export const OPENAI_CODEX_PROFILE: OAuthProviderProfile = {
  ...
  staticModels: [
    ...
    { modelId: 'gpt-5.4-mini',        contextWindow: 400_000,   maxOutputTokens: 128_000, endpointType: 'responses', supportsToolUse: true,  supportsVision: true,  inputCostPerMillionUsd: null, outputCostPerMillionUsd: null, reasoningConfig: { type: 'reasoning_effort', options: ['low', 'medium', 'high'], default: 'medium' } },
