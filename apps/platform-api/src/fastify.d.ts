...
import type { MissionControlWorkspaceService } from './services/workflow-operations/mission-control-workspace-service.js';
...
declare module 'fastify' {
  interface FastifyInstance {
    ...
    workflowOperationsWorkspaceService: MissionControlWorkspaceService;
