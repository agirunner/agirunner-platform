...
import type { DashboardProjectResourceRecord } from '../../lib/api.js';
import { Badge } from '../../components/ui/badge.js';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '../../components/ui/card.js';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '../../components/ui/table.js';
import { ErrorCard, LoadingCard, WorkspaceMetricCard } from './project-detail-shared.js';

export function ProjectResourcesTab({ projectId }: { projectId: string }): JSX.Element {
    ...
    <div className="space-y-4">
      <Card className="border-border/70 shadow-none">
        ...
        <CardContent className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          <WorkspaceMetricCard label="Resources" value={`${resources.length}`} detail="Configured project resource records." />
          <WorkspaceMetricCard
