    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Webhook Work Item Triggers
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="rounded-md border bg-border/10 p-3 text-sm text-muted">
          Webhook triggers belong to the project they automate. They create work items from
          inbound external events, verify the source signature, and wake the orchestrator through
        ...
        <div className="space-y-3">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <h3 className="text-sm font-medium">Current webhook triggers</h3>
              <p className="text-sm text-muted">Inspect, edit, toggle, or remove inbound webhook rules for this project.</p>
            </div>
