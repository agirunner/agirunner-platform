...
const WORKSPACE_ACTIONS = [
  {
    label: 'Settings',
    description: 'Project basics, lifecycle, repository defaults, and git credentials.',
    tab: 'settings',
    icon: Settings2,
  },
  {
    label: 'Knowledge',
    description: 'Project context, curated knowledge, memory, and run content in one place.',
    tab: 'knowledge',
    icon: BrainCircuit,
  },
  {
      ...
      <Card className="border-border/70 shadow-none">
        ...
        <CardContent className="space-y-4">
          ...
          {props.project.repository_url ? (
            ...
            <p className="text-sm leading-6 text-muted">
              Repository setup is optional. Add it in Settings only when this project should map
