...
export function AssistantSummaryCards(props: {
      ...
      <CardContent className="space-y-3 p-4">
        ...
        {props.suggestion.current_value ? (
          <div className="text-xs">
            ...
            <code className="text-red-600">{props.suggestion.current_value}</code>
          </div>
        ) : null}
        <div className="text-xs">
          <span className="text-muted">Suggested: </span>
          <code className="text-green-600">{props.suggestion.suggested_value}</code>
        </div>
