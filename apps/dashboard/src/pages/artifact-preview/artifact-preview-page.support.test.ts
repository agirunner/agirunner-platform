...
describe('artifact preview page support', () => {
  it('prefers the grouped work-item flow and demotes step detail to diagnostics', () => {
    expect(
      ...
      primaryHref:
        '/workflows/workflow-1?work_item_id=work-item-1&tab=live_console#work-item-work-item-1',
  ...
  it('falls back to the board stage flow, board context, or direct step record as needed', () => {
    expect(
      ...
      primaryHref: '/workflows/workflow-1?tab=needs_action#gate-review',
    ...
    expect(
      ...
      primaryHref: '/workflows/workflow-1',
  ...
  it('prefers explicit workspace and content return paths when provided', () => {
    expect(
      ...
      primaryHref: '/design/workspaces/workspace-1/artifacts?workflow_id=workflow-1',
    ...
    expect(
      buildArtifactPreviewOperatorNavigation({
        ...
        task: null,
        returnContext: {
          returnTo: '/design/workspaces/workspace-1/content?tab=artifacts&workflow=workflow-1',
          returnSource: 'workspace-content',
        },
      }),
    ).toEqual({
      primaryHref: '/design/workspaces/workspace-1/content?tab=artifacts&workflow=workflow-1',
