...
function readLlmProvidersSource(): string {
  return [
    ...
    'pages/llm-providers/llm-providers-page.chrome.tsx',
    'pages/llm-providers/llm-providers-page.defaults.ts',
    'pages/llm-providers/llm-providers-page-provider-dialogs.tsx',
    'pages/llm-providers/llm-providers-page-provider-cards.tsx',
    'pages/llm-providers/llm-providers-page-assignment-controls.tsx',
    'pages/llm-providers/llm-providers-page-assignment-summary.ts',
    'pages/llm-providers/llm-providers-page-assignments-section.tsx',
    'pages/llm-providers/llm-providers-page-catalog.tsx',
...
describe('LlmProvidersPage renders three sections', () => {
  ...
  it('renders the Providers section with heading and Add Provider button', () => {
    ...
    expect(source).toContain('Use your existing subscription');
  ...
  it('keeps oauth disconnect as a no-content-safe action and explains disconnected impact clearly', () => {
    const apiSource = readComponent('lib/dashboard-api/create-dashboard-api.ts');
  ...
  it('uses elevated provider surfaces so cards stay legible in dark theme', () => {
    ...
    expect(source).toContain('const SUBDUED_SURFACE_CLASS_NAME =');
    expect(source).toContain("'rounded-xl border border-border/70 bg-surface p-4 shadow-sm'");
