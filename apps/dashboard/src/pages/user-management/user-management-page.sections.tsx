    ...
    <Card className="border-amber-300 bg-amber-50 shadow-sm dark:border-amber-700 dark:bg-amber-950/30">
      <CardHeader>
        ...
        <CardDescription className="text-amber-900 dark:text-amber-200">
          API keys are the supported primary access model today. Keep this page only for existing SSO-backed administrative users, and use Admin → API Keys for normal operator access.
        </CardDescription>
      </CardHeader>
    </Card>
  );
