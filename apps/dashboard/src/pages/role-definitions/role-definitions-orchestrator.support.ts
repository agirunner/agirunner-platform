...
export function summarizeOrchestratorControlSurfaces(
  ...
  return [
    ...
    },
    {
      ...
      detail: `Orchestrator posture owns the primary orchestrator agent image and capacity. The Advanced agent settings page controls the shared specialist agent and specialist execution envelope and safeguards.`,
      href: '/config/orchestrator',
      label: 'Open orchestrator',
      secondaryHref: '/admin/agent-settings',
      secondaryLabel: 'Open advanced agent settings',
    },
    {
      id: 'specialists',
