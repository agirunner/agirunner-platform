  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Select which runtime tools and task sandbox tools this role can use.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <ToolGrantGroup
          title="Runtime tools"
          description="Run directly in the runtime loop and do not require a task sandbox."
          tools={runtimeTools}
          allowedTools={props.form.allowedTools}
          toggleTool={props.toggleTool}
        />
        <ToolGrantGroup
          title="Task sandbox tools"
