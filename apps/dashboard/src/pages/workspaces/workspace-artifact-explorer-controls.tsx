...
import type { WorkspaceArtifactScopeChip } from './workspace-artifact-explorer-adaptive-support.js';
import type { WorkspaceArtifactSort } from './workspace-artifact-explorer-support.js';

export function WorkspaceArtifactFilterCard(props: {
  ...
  roleCount: number;
  nextAction: string;
  scopeChips: WorkspaceArtifactScopeChip[];
  query: string;
  ...
  stageOptions: string[];
  workItems: DashboardWorkspaceArtifactWorkItemOption[];
  ...
  onSortChange(value: WorkspaceArtifactSort): void;
  onReset(): void;
}): JSX.Element {
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              {props.scopeChips.length > 0 ? (
                ...
                <Badge variant="outline">Workspace-wide artifact scope</Badge>
              )}
            </div>
          </div>
        ...
        <div className="grid gap-3 2xl:grid-cols-[repeat(5,minmax(0,1fr))_auto]">
          ...
          <ArtifactSelect
            label="Sort"
            value={props.sort}
            onValueChange={(value) => props.onSortChange(value as WorkspaceArtifactSort)}
          >
...
export function WorkspaceArtifactBulkActionBar(props: {
