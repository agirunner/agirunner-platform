...
export function WorkspaceArtifactExplorerSummary(props: {
...
export function WorkspaceArtifactExplorerList(props: {
...
export function WorkspaceArtifactQuickInspector(props: {
  artifact: WorkspaceArtifactEntry | null;
...
export function WorkspaceArtifactExplorerSkeleton(props: {
  showHeader: boolean;
}): JSX.Element {
  return (
...
function WorkspaceArtifactPagination(props: {
  page: number;
  totalPages: number;
  totalArtifacts: number;
  pageSize: number;
