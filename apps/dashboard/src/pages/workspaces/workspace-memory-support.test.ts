...
import {
  ...
  summarizeWorkspaceTimeline,
} from './workspace-memory-support.js';

describe('workspace memory support', () => {
  it('extracts workspace memory entries into table rows', () => {
    expect(
      extractMemoryEntries({
  ...
  it('summarizes unique workspace workflows with normalized continuity states', () => {
    expect(
      summarizeWorkspaceTimeline([
        {
          workflow_id: 'workflow-1',
