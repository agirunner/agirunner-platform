...
export function WorkspaceScheduledTriggerForm({
  form,
  workflows,
  stages,
  columns,
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted">
            Configure a recurring work-item creation rule for this workspace.
          </p>
        </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              ...
              {form.scheduleType === 'interval' ? (
                <FormInput
                  ...
                  placeholder="60"
                  description="Choose how often this workspace should create a new work item."
