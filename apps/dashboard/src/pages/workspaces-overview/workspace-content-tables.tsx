...
import { ArtifactCard, ArtifactDesktopRow } from './workspace-content-artifact-records.js';
import { DocumentCard, DocumentDesktopRow } from './workspace-content-document-records.js';
