      ...
      <CardHeader className="gap-3">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="space-y-1">
            ...
            <CardDescription>
              Operator-facing guardrails for spend, runtime, and orchestration volume.
            </CardDescription>
          </div>
            ...
            <div className="flex flex-wrap gap-2">
              {props.context === 'inspector' ? (
                <Button variant="outline" asChild>
                  <Link to={`/work/workflows/${props.workflowId}`}>Back to board controls</Link>
                </Button>
              ) : (
                <Button variant="outline" asChild>
                  <Link to={`/work/workflows/${props.workflowId}/inspector`}>
