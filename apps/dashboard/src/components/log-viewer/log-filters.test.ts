...
function readComboboxSource(): string {
  return [
    './ui/searchable-combobox.tsx',
    './ui/searchable-combobox.list.tsx',
    './ui/searchable-combobox.support.ts',
  ]
...
describe('log filters source', () => {
  ...
  it('renders combobox option labels with explicit foreground text so multi-select rows stay visible in dark theme', () => {
    const source = readComboboxSource();
